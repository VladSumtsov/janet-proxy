...
public class ProxySample {
  ...
  public static void main(String... args) throws Throwable {
    ...
    Observable.combineLatest(
        janet.createPipe(GithubAction.class, Schedulers.io()).createObservableResult(new GithubAction()).toObservable(),
        janet.createPipe(XkcdAction.class, Schedulers.io()).createObservableResult(new XkcdAction()).toObservable(),
        (githubAction, xkcdAction) -> new Object()
    ).blockingFirst();
  }
}
